...
import czihao.miaosha.access.AccessLimit;
import czihao.miaosha.rabbitmq.MQSender;
import czihao.miaosha.rabbitmq.MiaoshaMessage;
import czihao.miaosha.redis.GoodsKey;
import czihao.miaosha.redis.MiaoshaKey;
import czihao.miaosha.redis.OrderKey;
...
import czihao.miaosha.service.MiaoshaService;
...
/*
 * MiaoshaController 实现了 InitializingBean
 * */
@Controller
...
public class MiaoshaController implements InitializingBean {
    ...
    /*
     * 处理来自 http://localhost:8080/miaosha/reset 的请求
     * */
     ...
     */
    /*
     * 当在秒杀商品详情页面（goods_detail.html）点击“立即秒杀”按钮时，浏览器发送“/miaosha/do_miaosha”请求，
     * 此时该方法负责处理来自“/miaosha/do_miaosha”的请求.
     * */
    ...
    public Result<Integer> miaosha(Model model, MiaoshaUser user,
        ...
        //下面的代码是没有引入消息队列对下单操作进行异步处理，效率不高。
        /*
    	//判断库存
     ...
     */
    /*
     * 处理来自 http://localhost:8080/miaosha/result/ 的请求
     * */
